            ...
            <div class="">
                <form class="space-y-4" action="#">
                  ...
                  <div class="w-full gap-3 flex">
                    <div>
                    <label class="block mb-22 text-sm font-medium text-white" for="firstname">First Name</label>
                    <input type="text" name="firstname" id="firstname" class="bg-[#464646] border border-[#464646] text-gray-900 text-sm block w-full p-2.5" placeholder="First Name">
                    </div>
                    <div>
                    <label class="block mb-22 text-sm font-medium text-white" for="lastname">Last Name</label>
                    <input type="text" name="lastname" id="lastname" class="bg-[#464646] border border-[#464646] text-gray-900 text-sm block w-full p-2.5" placeholder="Last Name">
                    </div>
                  </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input type="number" name="number" id="number" class="bg-[#464646] border border-[#464646] text-gray-900 text-sm block w-full p-2.5" placeholder="Your Email" required />
                    </div>
                    <div>
